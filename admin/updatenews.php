...
$user = getNewsById($conn,$userId);
 ...
 if(isset($_POST['savebtn']))
 {
    if(isset($_FILES['file']))
    {
        ...
        @unlink('newsuploads/userimage'.$user['image']);
    }

    if(updatenews($conn,$_POST))
    {
        showMsg('News Updated Successfully.','success');
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <form class="form-horizontal" role="form"  method="POST" enctype="multipart/form-data"  >                                    
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" id="tnews" class="form-control"name="title" value="<?php echo $user['title']; ?>" required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <img class="img-thumbnail" src="newsuploads/userimage/<?php echo $user['image']; ?>" alt="image" width="100">
                                                    </div>
                                                </div>  
                                                <?php endif; ?>
                                                <div class="form-group">
                                                ...
                                                <br>
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" id="newss" class="form-control"name="source" value="<?php echo $user['source']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Publisher </label>
                                                    <div class="col-md-10">
                                                        <input type="text" id="Publisher" class="form-control"name="publisher" value="<?php echo $user['publisher']; ?>" required>
                                                    </div>
                                                </div>                                            
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select name="status" class="form-control">
                                                            <option value="published" <?php if($user['status']=='published') echo 'selected="selected"';  ?>>Published</option>
                                                            <option value="Unpublished" <?php if($user['status']=='Unpublished') echo 'selected="selected"';  ?>>Unpublished</option>
                                                        </select>
                                                    </div>
                                                </div> 
